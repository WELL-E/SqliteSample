...
namespace Sample.Comm
{
    ...
    public class VirtualizingList<T> : IList<T>, IList
    {
        ...
        public VirtualizingList(IItemsProvider<T> itemsProvider, int pageSize, int pageTimeout)
        {
        ...
        /// <param name="itemsProvider">The items provider.</param>
        /// <param name="pageSize">Size of the page.</param>
        public VirtualizingList(IItemsProvider<T> itemsProvider, int pageSize)
        {
            _itemsProvider = itemsProvider;
            _pageSize = pageSize;
        }
        ...
        /// </summary>
        /// <param name="itemsProvider">The items provider.</param>
        public VirtualizingList(IItemsProvider<T> itemsProvider)
        {
            _itemsProvider = itemsProvider;
        }
